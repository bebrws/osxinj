...
{
    return [[self alloc] initWithObjCIvar: ivar]; // [[[self alloc] initWithObjCIvar: ivar] autorelease];
}

+ (id)ivarWithName: (NSString *)name typeEncoding: (NSString *)typeEncoding
{
    return [[self alloc] initWithName: name typeEncoding: typeEncoding]; // [[[self alloc] initWithName: name typeEncoding: typeEncoding] autorelease];
}
