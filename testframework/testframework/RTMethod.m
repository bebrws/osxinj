...
{
    return [[self alloc] initWithObjCMethod: method]; //[[[self alloc] initWithObjCMethod: method] autorelease];
}

+ (id)methodWithSelector: (SEL)sel implementation: (IMP)imp signature: (NSString *)signature
{
    return [[self alloc] initWithSelector: sel implementation: imp signature: signature]; //[[[self alloc] initWithSelector: sel implementation: imp signature: signature] autorelease];
}
