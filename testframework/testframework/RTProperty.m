...
{
    return [_attrs copy]; // [[_attrs copy] autorelease];
}
...
{
    return [[self alloc] initWithObjCProperty: property];// [[[self alloc] initWithObjCProperty: property] autorelease];
}

+ (id)propertyWithName: (NSString *)name attributes:(NSDictionary *)attributes
{
    return [[self alloc] initWithName: name attributes: attributes]; //[[[self alloc] initWithName: name attributes: attributes] autorelease];
}
