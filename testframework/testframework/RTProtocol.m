...
{
    return [[self alloc] initWithObjCProtocol: protocol]; // [[[self alloc] initWithObjCProtocol: protocol] autorelease];
}

+ (id)protocolWithName: (NSString *)name
{
    return [[self alloc] initWithName: name]; // [[[self alloc] initWithName: name] autorelease];
}
